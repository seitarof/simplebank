...
// Source: github.com/pyotarou/simplebank/db/sqlc (interfaces: Store)
...
// GetSettion mocks base method.
func (m *MockStore) GetSettion(arg0 context.Context, arg1 uuid.UUID) (db.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSettion", arg0, arg1)
	ret0, _ := ret[0].(db.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetSettion indicates an expected call of GetSettion.
func (mr *MockStoreMockRecorder) GetSettion(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSettion", reflect.TypeOf((*MockStore)(nil).GetSettion), arg0, arg1)
}
